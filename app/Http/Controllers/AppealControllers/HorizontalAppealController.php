...
class HorizontalAppealController extends Controller
{
    protected $database;
    protected $storage;
    ...
    public function index()
    {
        ...
        if ($docRef->size() == 0) {
            ...
            return view('appealScreens.harizontalAppeal', compact('data'));
        }
        foreach ($docRef->rows() as $document) {
            if (!$document->exists()) return view('appealScreens.harizontalAppeal');
            else {
