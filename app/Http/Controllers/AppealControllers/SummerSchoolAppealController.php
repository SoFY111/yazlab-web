...
class SummerSchoolAppealController extends Controller
{
    protected $database;
    protected $storage;
    ...
    public function index()
    {
        ...
        if ($docRef->size() == 0) {
            ...
            return view('appealScreens.summerSchoolAppeal', compact('data'));
        }
        foreach ($docRef->rows() as $document) {
            if (!$document->exists()) return view('appealScreens.summerSchoolAppeal');
            else {
