...
@section('title') Yatay Geçiş Başvuru @endsection
@section('headerTitle') Yatay Geçiş Başvuru @endsection
@section('content')
    <div class="w-2/3 border-b py-2 m-auto flex flex-row items-center justify-center">
        <h2 class="font-medium" style="font-size: 22px;">Yatay Geçiş Başvuru</h2>
    </div>
    <div class="container">
        <div class="flex flex-col justify-center items-center">
            ...
            <form class="w-2/3 m-0 p-4 flex flex-row items-center" id="fileQForm">
                <div class="flex-grow flex flex-col" id="fileQInputDiv">
                    <label class="block text-grey-darker text-sm mb-1" for="fileX">ÖSYM Sonuç Belgesi</label>
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker outline-none"
                           id="fileQ" name="fileQ" type="file" >
                </div>
                <div class="ml-2">
                    <label class="block opacity-0 text-sm mb-1">ÖSYM Sonuç Belgesi</label>
    ...
    @if($data->firstOpening == 1)
        ...
        <div
            ...
            <div class="mt-3 text-center">
                ...
                <h3 class="text-lg leading-6 font-medium text-gray-900">Yatay Geçiş Başvuru Sayfasına <br/>Hoş Geldiniz!</h3>
                <div class="mt-2 px-7 py-3">
                    <ul class="text-sm text-gray-500">
                        <li>Ders İçerikleri</li>
                        <li>Ders Planı/Müfredatı</li>
                        <li>Transkript</li>
                        <li>ÖSYM Sonuç Belgesi</li>
                    </ul>
